...
Since Greedybear v1.1.0 we added a Registration Page that can be used to manage Registration requests when providing ThreatPot as a Service.
...
Check the [API specification](https://khulnasoft.github.io/devsec-docs/ThreatPot/Api-docs/) or the to get all the details about how to use the available APIs.
